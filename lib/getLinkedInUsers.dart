...
class GetLinkedInUsers extends StatefulWidget {
  @override
...
Future<LinkedinModel> getList(
  ...
  String apiUrl = "https://acmhack.herokuapp.com/linkedin";
...
class _GetLinkedInUsersState extends State<GetLinkedInUsers> {
